Feature: Verifying OMR Branch Hotel Cancel Booking Page Automation

  Scenario Outline: Cancel the hotel booking
    ...
    Then User should verify after the cancel order Id success msg "Your booking cancelled successfully"
    ...
    Examples: 
      ...
      | meenusakthi.2m24@gmail.com | Meena@1998 | Tamil Nadu  | Madurai    | Deluxe         | 2023-08-17 | 2023-08-20 | 1-One     | 1-One      |            1 | Ms.        | Priya     | Sri      | 9876543210 | meenusakthi.2m24@gmail.com | 9043592058 | Greens Tech OMR Branch | Thoraipakkam   | Need early check in    | creditCard |2023-08-31 |

  Scenario Outline: Cancel the hotel booking by pass the order id in examples
    Given User is on the OMR Branch hotel page
    When User login "<userName>","<password>"
    Then User should Verify success message after login "Welcome Meena"
    When User navigate to My Account page
    ...
    Then User cancel the given order Id "<orderId>"
    And User should verify after the cancel order Id success msg "Your booking cancelled successfully"

    Examples: 
      | userName                   | password   | orderId    |
      | meenusakthi.2m24@gmail.com | Meena@1998 | VHCSD47564 |

  Scenario Outline: Cancel the first hotel booking
    Given User is on the OMR Branch hotel page
    When User login "<userName>","<password>"
    Then User should Verify success message after login "Welcome Meena"
    When User navigate to My Account page
